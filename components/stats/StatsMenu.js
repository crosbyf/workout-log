        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className={`px-3 py-1 rounded-lg text-sm font-semibold transition-all ${
              showFilter ? 'bg-blue-500 text-white' : `${currentTheme.cardBorder} ${currentTheme.text}`
            }`}
            style={{
              backgroundColor: showFilter ? undefined : 'transparent',
              border: showFilter ? undefined : `1px solid ${currentTheme.cardBorder}`,
            }}
          >
            Filter
          </button>
      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <div className={`text-sm opacity-75 ${currentTheme.text}`}>Protein Intake</div>
              <div className={`font-bold ${currentTheme.text}`}>{todayProtein}g today</div>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <div className={`text-sm opacity-75 ${currentTheme.text}`}>Body Weight</div>
              <div className={`font-bold ${currentTheme.text}`}>{latestWeight ? `${latestWeight} lbs` : 'Track your weight'}</div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
        ...
        >
          <div className="flex items-center gap-4">
            <div className="text-3xl">📊</div>
            <div className="text-left">
              <div className={`text-sm opacity-75 ${currentTheme.text}`}>Exercise Stats</div>
              <div className={`font-bold ${currentTheme.text}`}>{uniqueExercises.size} unique exercises</div>
            </div>
          </div>
          <ChevronRight className={currentTheme.text} />
        </button>
